...
public class BaseTest {
    ...
    public void Education() throws MalformedURLException {
        if(localAndroid){
            ...
            desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE,"com.mobisoft.ozdilekteyim");
            desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY,"com.mobisoft.ozdilekteyim.main.SplashActivity");
            desiredCapabilities.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, 3000);
            URL url = new URL("http://127.0.0.1:4723/wd/hub");
            appiumDriver = new AndroidDriver(url, desiredCapabilities);
        }else{
            System.out.println("İOS testi başlatılıyor");
            DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
            desiredCapabilities
            ...
            desiredCapabilities
                    .setCapability(IOSMobileCapabilityType.BUNDLE_ID, "com.pozitron.ozdilekteyim");
            desiredCapabilities
